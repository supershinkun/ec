...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    zipcode = models.CharField('郵便番号', max_length = 8, blank=True)
    address1 = models.CharField('都道府県', max_length=500, null=True, blank=True)
    address2 = models.CharField('市区町村番地', max_length=500, null=True, blank=True)
    address3 = models.CharField('建物名', max_length=500, null=True, blank=True)
    ...
    REQUIRED_FIELDS = ['zipcode', 'address1', 'address2', 'address3']
