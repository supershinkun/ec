# Generated by Django 2.1.1 on 2019-09-15 08:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=150, verbose_name='名前')),
            ],
            options={
                'verbose_name': 'カテゴリー',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='isehan.Category', verbose_name='カテゴリー')),
            ],
            options={
                'verbose_name': '商品',
