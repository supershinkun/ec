"""
Django settings for mk_ec project.
...
SECRET_KEY = 'xq04c@f8+j&#a(ybsqd@as=$5mq2x9l)d3tsoh7_av^4&iult0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'isehan.common_context.common',
            ],
        },
    },
]

WSGI_APPLICATION = 'mk_ec.wsgi.application'
...
# auth
AUTH_USER_MODEL = 'isehan.User'

# login,logout
LOGIN_URL = 'isehan:login'
LOGIN_REDIRECT_URL = 'isehan:top'
LOGOUT_REDIRECT_URL = 'isehan:top'
